...
/**
 * Created by myyusuf on 9/24/16.
 */
public class DashboardConstant {

    public static final String BASE_URL = "http://10.0.2.2:3300/api/";
//    public static final String BASE_URL = "http://128.199.78.68:4000/api/";
