 ...
 * {@link OpFragment.OnOpFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link OpFragment#newInstance} factory method to
...
public class OpFragment extends Fragment {
    ...
    private OnOpFragmentInteractionListener mListener;
    ...
    public static OpFragment newInstance(String param1, String param2) {
...
//        drawChart(planDataEntries, actualDataEntries);
    ...
    private void getData(int selectedYear) throws Exception{
        ...
        String baseURL = DashboardConstant.BASE_URL + "dashboard/op/" + selectedYear;
...
//                Log.v("KAT", "MyAuth: authenticating");
                ...
                String encodedString = Base64.encodeToString(String.format("%s:%s", OpFragment.this.mParam1, OpFragment.this.mParam2).getBytes(), Base64.NO_WRAP);
    ...
    public void onButtonPressed(Uri uri) {
        if (mListener != null) {
            mListener.onOpFragmentInteraction(uri);
        }
    }
    ...
    public void onAttach(Context context) {
        ...
        if (context instanceof OnOpFragmentInteractionListener) {
            mListener = (OnOpFragmentInteractionListener) context;
        } else {
     ...
     */
    public interface OnOpFragmentInteractionListener {
