 ...
 * {@link ProgFragment.OnProgFragmentInteractionListener} interface
...
public class ProgFragment extends Fragment {
    ...
    private OnProgFragmentInteractionListener mListener;
    ...
    public void onButtonPressed(Uri uri) {
        if (mListener != null) {
            mListener.onProgFragmentInteraction(uri);
        }
    }
    ...
    public void onAttach(Context context) {
        ...
        if (context instanceof OnProgFragmentInteractionListener) {
            mListener = (OnProgFragmentInteractionListener) context;
        } else {
     ...
     */
    public interface OnProgFragmentInteractionListener {
        // TODO: Update argument type and name
        void onProgFragmentInteraction(Uri uri);
    }
}
